...
# Two flaws stood out to me. The first is 12 states had no data in the first column and the lack of data in those rows is accompanied by two rows with no data. The second is the columns are not labeled in a clear and descriptive way. After watching Sean's video, the major flaw that I missed was that the values in the second and third columns are being categorized as characters rather than as numbers.
