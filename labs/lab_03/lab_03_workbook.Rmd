...
# A: Prince George's County with 29.27 cases per 1000
...
# A: Bath County with 0.91 cases per 1000
...
# A: The two areas are Hancock, GA and Galax City, VA
...
covid_Maryland_county_june_aug_pct_change <- covid_county_monthly_death_rate %>%
...
# Write the name of the object you just created below so it displays below in the markdown document
  ...
  covid_Maryland_county_june_aug_pct_change
...
covid_Texas_county_may_aug_pct_change <- covid_county_monthly_case_rate %>%
...
covid_Texas_county_may_aug_pct_change
...
# Which Rhode Island county had the largest percentage change in cumulative case rate between July and August?

covid_RI_county_july_aug_pct_change <- covid_county_monthly_case_rate %>%
  select(county, state, d_2020_07_30, d_2020_08_30) %>%
  filter(state == "Rhode Island") %>%
  mutate(july_aug_pct_change = (d_2020_08_30 - d_2020_07_30)/d_2020_07_30) %>%
  arrange(desc(july_aug_pct_change))

covid_RI_county_july_aug_pct_change


# Q: Which Rhode Island county had the largest percentage change in cumulative case rate between July and August? 
# A: Washington County
